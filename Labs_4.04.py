...
# Create a function, all_in_one, that will put all the shopping lists into a
# single combined list using a for loop.
def all_in_one():
    combined_list = []
...
def count_q_tips(list_choice):
    ...
    print(f"There are {count_q_tips} q-tips in the list")
...
while True:
    user_choice = input("Choose: 1 = update item, 2 = view item, 3 = view list,"
    " 4 = combine all lists, 5 = count number of q tips in a list, 6 = add milk in lists not containing milk,"
    " 7 = change milk to milk & cookies, or q = quit: ") 
    ...
    if user_choice == '1':
        ...
        user_choice = int(input("Which list do you want to know the number of q-tips? ")) -1
